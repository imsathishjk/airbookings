    ...
    <div className="landingPage">
        <div className="landingHero">
          ...
          <div className="landingHero-title">
            <h1 className="banner-h1">Discover the World with One Tap</h1>
            <p className="banner-p">Quick search, easy booking, and secure payments for stress-free travel.</p>     
          </div>
        ...
        <div className="container">
            ...
            <span><h5>2025 Air Bookings - &copy; All rights reserved</h5></span>
